...
| `get_alpha` | Compute load factor |

------------------------------------------------------------------------------------

## Collision Handling (Chaining)

- Multiple keys hashing to the same index are stored in a list (bucket)
...
- Resize is triggered when projected load factor exceeds threshold
...
- Handles insert, update, lookup, delete
- Manages resizing and rehashing
- Enforces invariants to ensure correctness
- Contains optional debug/print utilities
...
- Emphasizes correctness and invariants
...
If you want next:
- a **top-level README** comparing multiple data structures
- Big-O and memory comparison tables
- benchmarks against Python `dict`
- or extensions like open addressing or tree-based buckets
